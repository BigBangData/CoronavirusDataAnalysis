...
This is an old project from April 2020. At that time, the JHU CCSE data structures were changing often. I abandoned the project and just re-ran the code, which survived inactivity. If the JHU CCSE data structures changed, these changes were minor and did not break the analysis.
...
Top and bottom rows of the pre-processed data:

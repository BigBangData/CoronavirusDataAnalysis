...
# test with Greece fatalities
x <- percap[percap$Country == "Greece" & percap$Status == "Fatal" & percap$Log2RateOfChange > 0, ]
...
ggplot(x, aes(x = Date)) +
	...
	scale_y_continuous(sec.axis = sec_axis(~.*1000, name = "Count")) +
	scale_colour_manual(values = c("black", "red")) +
	labs(title = "Greece Fatalities"
		,y = "Log2 Rate of Change"
		,x = ""
		,colour = "Parameter") +
	theme(legend.title = element_blank(), legend.position = c(.6, .9))

# test with Turkey fatalities
x <- percap[percap$Country == "Turkey" & percap$Status == "Fatal" & percap$Log2RateOfChange > 0, ]
